...
with an application to image-based rendering.  The system
uses a novel method of triangular segmentation to produce a compact
representation suitable for image-based rendering applications.
Although the system works for highly-textured scenes with little
occlusion, future work could address problems posed by
textureless as well as shiny, specular surfaces.  Finally,
the system could be optimized to take advantage of modern
graphics-processing units for a potentially real-time implementation.

\begin{figure}[ht]
  \centering
  \includegraphics[width=2.5in]{images/r1}
  \includegraphics[width=2.5in]{images/r2}
  \includegraphics[width=2.5in]{images/r3}
  \includegraphics[width=2.5in]{images/r4}
  \includegraphics[width=2.5in]{images/r5}
