...
To get a more dense set of depth samples additional KLT feature
...
outlined above, which would result in a slower process
which would also be more error-prone due to the lower-quality
feature points and increased number of outliers, a probabilistic
